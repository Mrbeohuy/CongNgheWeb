...
<body>
    ...
    $ho_ten = "Nguyễn Trọng Huy";      // Thay bằng tên của bạn
    $diem_tb = 8;                // Thay bằng điểm bạn muốn
    $co_di_hoc_chuyen_can = true;  // Có thể đổi thành false để thử
    ...
    // TODO 3: Cấu trúc IF / ELSE IF / ELSE để xếp loại
